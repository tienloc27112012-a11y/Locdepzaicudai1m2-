--// This file was created by XHider https://discord.gg/infinityscript
	...
	World2 = tostring(game.PlaceId) == "4442272183"
	World3 = tostring(game.PlaceId) == "7449423635"
	...
	-- removed unstable hook
	-- removed unstable hook
	-- removed silent error hooks for debugging
	...
	Attack.Pos = function(model, dist)
		return model and model.Position and (Root.Position - model.Position).Magnitude <= dist
	end
	Attack.Dist = function(model, dist)
		return (Root.Position - (model:FindFirstChild("HumanoidRootPart") and model:FindFirstChild("HumanoidRootPart").Position or Root.Position)).Magnitude <= dist
	end
	...
	BringEnemy = function()
		...
		for _, v in pairs(workspace.Enemies:GetChildren()) do
			if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
				if v.PrimaryPart and (v.PrimaryPart.Position - PosMon).Magnitude <= 250 then
